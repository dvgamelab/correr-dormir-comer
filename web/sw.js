...
const V = "cdc-v3";
const SHELL = ["./", "index.html", "app.css", "vendor-leaflet.css", "app.js", "manifest.webmanifest", "icon.svg", "icon-192.png", "icon-512.png", "data/spain.geo.json", "data/municipios.json"];
